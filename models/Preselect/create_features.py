...
def event_feature(df):
    columns_users = ['career_level_user','region_user','industry_id_user','discipline_id_user','country_user','experience_years_experience','edu_degree','experience_years_in_current','gender']
...
def Intu_Intusers(df,users,items,user_key='user_id',item_key='item_id'):  
    ...
    Intusercolumns = [ 'career_level', 'discipline_id', 'industry_id','region','country',
       'experience_years_experience', 'experience_years_in_current','edu_degree','jobrole_list','gender']
...
def click_ratio(df,user_key='user_id',item_key='item_id'):
    ...
    temp_df = last_week_click_counts/week_before_last_click_counts
    temp_df = temp_df.reset_index()
    df =df.join(temp_df, on='item_id',rsuffix='_click_ratio')
    print(df.columns)
